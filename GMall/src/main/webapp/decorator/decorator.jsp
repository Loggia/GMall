...
<body>
								...
								<ol id="mymenu_Form">
									...
									<c:if test="${LOGIN_MEMBER.id != null }">
									    <c:if test="${LOGIN_MEMBER.type== 1 }">
								    	    ...
								    	    <li class="mymemu_list" style="margin: 5px;"><a style="text-decoration: none;" class="ml" href="${path }/trade/delevery.mall">배송정보</a></li>
								    	</c:if>
	...
	<footer class="container-fluid" style="padding: 0px 0px 0px 0px;">
		...
		<div class="col-xs-12" style="height: 100px; position: absolute; text-align: center; border-top: 1px solid #a3a4a6;">
			<br>
			<img src="../img/goodee_gray.png" style="width: 200px; height: 70px; display: inline;">
			<br><br>
			<p>
