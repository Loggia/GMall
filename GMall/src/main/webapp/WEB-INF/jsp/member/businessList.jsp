					...
					<div align="center">
						<ul class="pagination">
							<c:if test="${pageNum == 1}">
								...
								<c:if test="${pageNum > 1}">
								<li class="">
									<a href="javascript:businessList(${pageNum - 1})" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a>
								</li>
							</c:if>
							...
							<c:forEach var="a" begin="${startpage}" end="${endpage}">
								...
								<c:if test="${pageNum != a}">
									<li>
										<a href="javascript:businessList(${a})">${a}<span class="sr-only"></span></a>
									</li>
								</c:if>
							</c:forEach>
							...
							<c:if test="${pageNum < maxpage}">
								<li>
									<a href="javascript:businessList(${pageNum + 1})" aria-label="Next"><span aria-hidden="true">&raquo;</span></a>
								</li>
							</c:if>
						</ul>
					</div><br><br><br>
