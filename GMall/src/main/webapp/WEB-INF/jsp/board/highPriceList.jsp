    ...
    $(window).scroll(function(){ // ① 스크롤 이벤트 최초 발생
        ...
        if( currentScrollTop - lastScrollTop > 0 ){
            ...
            if ($(window).scrollTop() >= ($(document).height() - $(window).height()-1) ){ //② 현재스크롤의 위치가 화면의 보이는 위치보다 크다면
                ...
                $.ajax({   
                    ...
                    url : 'highinfiniteScrollDown.mall',// 요청할 서버의 url
                    headers : {
                            ...
                            $(data).each(
                                ...
                                function(){
                                    ...
                                    str +=  "<tr class=" + "'listToChange'" + ">"
                                        +       "<td class=" +  "'scrolling'" + " data-price='" + this.price + "' data-cate='" + this.category + "'>" + "<img src='../picture/" + this.fileurl + "' width='70' height='70' />" + "</td>"
                                        +       "<td>" + this.pro_name + "</td>"      
                                        +       "<td>" + this.price + "</td>"
                                        +       "<td>" + this.date + "</td>"
                                        +       "<td>" + this.bis_name + "</td>"
        ...
        */
            ...
            if ( $(window).scrollTop() <= 0 ){ //
                ...
                $.ajax({
                    type : 'POST',  // 요청 method 방식
                    url : 'highinfiniteScrollUp.mall',// 요청할 서버의 url
                    headers : {
                        "Content-Type" : "application/json",
                        "X-HTTP-Method-Override" : "POST"
                    },
