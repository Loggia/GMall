...
<form:form modelAttribute="board" action="reviewupdate.mall?pro_no=${pro_no}&pageNum=${pageNum}" enctype="multipart/form-data" name="updateform">
	...
	<table class="table table-hover" style="border-bottom: 1px solid #e5e5e5; width:600px;" align="center">
	  <tr><td colspan="2" align="center"><h2>Review 수정</h2></td></tr>
	  <tr><td>제목</td>     
      ...
      <tr>
        <td colspan="2" align="center">
          ...
          <button class="btn btn-default"><a href="reviewdeleteForm.mall?pro_no=${board.pro_no}&num=${board.board_no}&pageNum=${pageNum}">삭제</a></button>
